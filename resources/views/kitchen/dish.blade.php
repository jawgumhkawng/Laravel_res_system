                ...
                @foreach ($dishes as $dish )
                    ...
                    <td class="text-center">                
                      <form action="dish/{{ $dish->id }} " method="post">
                        @csrf
                        @method('DELETE')
                          <a href="dish/{{ $dish->id }}/edit" class="btn btn-sm btn-warning  "><i class="fas fa-cog"></i></a>
                          <button type="submit" onclick="return confirm('Are you sure, you want to DELETE this {{ $dish->name }}?')" class="btn btn-sm btn-danger"><i class="fas fa-trash-alt"></i></button>
                      </form>
                    </td>
                </tr>
                @endforeach
